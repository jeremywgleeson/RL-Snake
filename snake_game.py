...
class Graphics:
    def __init__(self, window_size=None, grid_size=None, margin=1, edge_margin=2, top_margin = 50):
        pygame.init()
        self.font = pygame.font.SysFont("monospace", 19)
        # set window size
        if not window_size:
            self.window_size = self.window_width, self.window_height = 421,471
        else:
        ...
        # set square size
        self.square_size = self.square_width, self.square_height = (self.window_width)//(self.grid_width) -self.margin, (self.window_height-self.top_margin)//(self.grid_height) -self.margin
    ...
    def draw_container(self):
        ...
        game_width = (self.margin + self.grid_width) * self.square_width
        game_height = (self.margin + self.grid_height) * self.square_height - self.top_margin

        pygame.draw.rect(self.screen, color, [0, self.top_margin, game_width, self.margin])
        pygame.draw.rect(self.screen, color, [0, self.top_margin, self.margin, game_height])
        pygame.draw.rect(self.screen, color, [game_width - self.margin, self.top_margin, self.margin, game_height])
        pygame.draw.rect(self.screen, color, [0, game_height - self.margin + self.top_margin, game_width, self.margin])
...
class Game:
    def __init__(self, size=(20,20), graphics=False):
        ...
        self.grid.set_val(*new_head, SNAKE_HEAD)
